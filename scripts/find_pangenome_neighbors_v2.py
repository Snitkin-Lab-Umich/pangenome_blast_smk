...
# change this script to account for refound genes differently:
# search through the panaroo gff files (which have refound genes included) to find neighboring genes
# include this information in the neighbor file
# consider also including a column for gene length and other features
# remember that gene_data.csv and final_graph.gml contain information on each gene in the format [isolate_id]_[chromosome_id]_[gene_id]
